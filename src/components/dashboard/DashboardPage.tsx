...
import { Leaf, FileText, Calendar, Plus } from "lucide-react";
...
const DashboardPage = () => {
  const stats = [
    ...
    },
    {
      title: "Próxima Busca",
      value: "14:00",
      description: "Agendada para hoje",
      icon: Calendar,
      color: "text-primary"
    }
  ];
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg bg-accent/10 border border-accent/20">
                ...
                <div className="text-right">
                  <p className="font-bold text-accent">Hoje 14:00</p>
